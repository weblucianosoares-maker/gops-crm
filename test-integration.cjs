...
AA-LKAP -  Adailton,,,,,,,,,,,Analista,,,,https://lh3.googleusercontent.com/contacts/AG6tpzHQfddJRqC62qXCgwlRv-tIJh4FjYJ04Ij7lccIHtcDbqYn_o4r,GR Alta Performance ::: Importado 25/04/2018 ::: * myContacts,* Other,adailton.macedo@gmail.com,,,,,,021 997523023,,,,,,,,,,,,,,,,,,,,,,,,,,,,
AA-LKAP -  Adriana Smaniotto,,,,,,,,,,,Analista,,,,,GR Alta Performance ::: Importado 25/04/2018 ::: * myContacts,* Other,smaniottoac@bol.com.br,,,,,,54 991859257,,,,,,,,,,,,,,,,,,,,,,,,,,,,`;
    ...
    const parsedData = results.data
      ...
      .map((row) => {
        ...
        return {
          ...
          source: source,
          status: status,
          lastcontact: row.lastContact || row['Último Contato'] || new Date().toLocaleDateString('pt-BR'),
          initials: initials,
      ...
      const { data, error } = await supabase.from('leads').insert(parsedData).select();
      if (error) {
